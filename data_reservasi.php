        ...
        <table class="table table-striped table-hover">
            ...
            ?>
                <tr>
                    ...
                    <td>
                    <a href="index2.php?p=hapus_reservasi&&idreservasi=<?php echo $d['idreservasi']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                </td>
                </tr>
